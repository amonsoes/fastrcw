...
from src.adversarial.jpeg_quantization import RGBConversion, UnquantizedJPEGConversion, QuantizedJPEGConversion
...
##  Pytorch Version written by A. S.
#
######################################
...
class FastAdversarialRounding(Attack):
    ...
    def to_jpeg(self, image, quality):
        with torch.no_grad():
            ...
            adjusted_image = compress_decompress(image.unsqueeze(0))
